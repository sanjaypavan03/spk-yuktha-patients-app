...
const getStyles = (theme: any) => StyleSheet.create({
    ...
    header: { padding: 24, paddingTop: Platform.OS === 'ios' ? 60 : 40, paddingBottom: 40, borderBottomLeftRadius: 32, borderBottomRightRadius: 32, overflow: 'hidden', position: 'relative' },
    ...
    headerBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 16, height: 40, borderRadius: 12, marginRight: 10, gap: 8 },
    headerBadgeLabel: { color: '#FFF', fontSize: 14, fontWeight: 'bold' },

    main: { paddingHorizontal: 16, paddingTop: 24 },
    tabsWrapper: { marginTop: 16, backgroundColor: theme.card, borderRadius: 40, borderWidth: 1, borderColor: theme.border, shadowColor: theme.shadow, shadowOffset: { width: 0, height: 15 }, shadowOpacity: 0.06, shadowRadius: 25, elevation: 8, overflow: 'hidden' },
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent} bounces={true}>
                ...
                <View style={styles.main}>
                    {reviewing && extractedData ? (
                        ...
                        <View style={[styles.tabsWrapper, { marginTop: 16, padding: 20 }]}>
